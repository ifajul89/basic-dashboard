  ...
  return (
    <div className="border-[1px] border-gray-200 flex items-center p-3 justify-between rounded-lg">
      {Task ? (
        ...
        <div>
          <h5 className="text-xs sm:text-sm font-light text-gray-500">
            {Time}
          </h5>
          <h5 className="text-sm sm:text-base">{Log}</h5>
        </div>
      )}
      {TaskNumber ? (
        ...
        <h6 className="text-gray-500 font-light text-sm sm:text-base">
          {Logger}
        </h6>
      )}
    </div>
